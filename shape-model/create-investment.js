...
try {
  ...
  const package = await Investment_package.findOne({
   ...
   if (!package)throw new Error("there was an error with the investment plan you selected"); 
  //  {
...
if(return_t.error) throw new Error({error:true,errMessage:return_t.errMessage}) 
